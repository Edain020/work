...
* @return サウンドバッファ
*/
XAUDIO2_BUFFER* CreateSound(const char *file, bool loop)
{
	SoundData data;
...
void Sound::Load(const char *file, bool loop)
{
...
void Sound::Play(void)
{
	...
	{
		Stop();
		m_pSpeaker = PlaySound(m_pSound);
		m_pSpeaker->SetVolume(m_fVolume);
	}
}
